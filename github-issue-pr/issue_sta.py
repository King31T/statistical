...
def get_open_issues_count(owner, repo, token, until_time):
    ...
    while True:
        ...
        issues = [issue for issue in issues if not "pull_request" in issue]
